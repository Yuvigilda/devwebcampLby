<fieldset class="formulario_fieldset">
    ...
    <div class="formulario__campo">
     ...
     <div class="formulario__campo">
        ...
        <textarea class="formulario__input" name="descripcion" id="descripcion" placeholder="Descripcion evento" rows="7"><?php echo $evento->descripcion; ?></textarea>
    </div>
    <div class="formulario__campo">
        <label for="categoria" class="formulario__label">
     ...
     <div class="formulario__campo">
        <label for="dia" class="formulario__label">
            Selecciona el dia:
        </label>
...
<fieldset class="formulario__fieldset">
    ...
    <div class="formulario__campo">
        ...
        <input type="number" min="1" class="formulario__input" name="disponibles" id="disponibles" placeholder="ej: 20" value="<?php echo $evento->disponibles; ?>">
    </div>
</fieldset>