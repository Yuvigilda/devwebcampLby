<fieldset class="formulario__fieldset">
    ...
    <div class="formulario__campo">
        ...
        <input type="file" class="formulario__input formulario__input--file" id="imagen" name="imagen" value="<?php echo $ponente->imagen ?? ''; ?>">
    </div>
    ...
    <?php if (isset($ponente->imagen_actual)) { ?>
        ...
        <div class="formulario__imagen">
            <picture>
                ...
                <img loading="lazy" src="/img/speakers/<?php echo $ponente->imagen; ?>.jpg" width="500" height="300" alt="imagen ponente">
            </picture>
        </div>
    <?php } ?>
...
<fieldset class="formulario__fieldset">
    ...
    <div class="campo">
        <label for="tags-input" class="formulario__label">Areas de experiencia(separadas por comoa):</label>
        <input type="text" class="formulario__input" id="tags-input" placeholder="Ejemplo: Node, JS, PHP, JavaScript">
